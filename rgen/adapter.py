...
class Adapter:
    ...
    def _gen_copilot_instructions(
        ...
        return (
            ...
            f"3. Publish mandatory header:\n"
            f"   ```\n"
            f"   🤖 <model> | Agent: <agent> | Scenario: <scenario> | Budget: ~<N>k tok | Routing: <stats>\n"
            f"   ```\n"
            f"4. Stay within the declared budget. If you expect to exceed it, warn the user and ask for confirmation.\n\n"
            f"### Agents\n| Agent | Domain |\n|-------|--------|\n{agent_table}\n\n"
            f"### Key scenarios\n{scenario_list}\n\n"
            f"### Router commands\n"
            f"```\n"
