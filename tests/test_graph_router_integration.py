...
def mock_route_query():
    ...
    def _route_query(query: str, context: dict | None = None) -> dict:
        ...
        target_agent = (context or {}).get("target_agent") if context else None
        if target_agent == "devops":
            return {
                "agent": "devops",
